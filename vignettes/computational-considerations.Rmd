...
\begin{align*}
1 - F_{\tau_n}(t)
&= 1 - \left[(t Q(n\alpha, \alpha t) - n Q(n\alpha + 1, \alpha t)) - (t Q((n-1)\alpha, \alpha t) - (n-1)Q((n-1)\alpha + 1, \alpha t)) + 1\right] \\
&= (n Q(n\alpha + 1, \alpha t) - t Q(n\alpha, \alpha t)) - ((n-1)Q((n-1)\alpha + 1, \alpha t) - t Q((n-1)\alpha, \alpha t)) \\
&= (n Q(n\alpha + 1, \alpha t) + t Q((n-1)\alpha, \alpha t)) - ((n-1)Q((n-1)\alpha + 1, \alpha t) + t Q(n\alpha, \alpha t))
\end{align*}
...
\begin{align*}
F_{\tau_n}(t) &= \int_0^t \left[P((n-1)\alpha, \alpha u) - P(n\alpha, \alpha u)\right] \mathrm{d}u \\
&= (t P((n-1)\alpha, \alpha t) - (n-1)P((n-1)\alpha + 1, \alpha t)) - (t P(n\alpha, \alpha t) - n P(n\alpha + 1, \alpha t)) \\
&= (t P((n-1)\alpha, \alpha t) + n P(n\alpha + 1, \alpha t)) - (t P(n\alpha, \alpha t) + (n-1)P((n-1)\alpha + 1, \alpha t))
\end{align*}
...
Through playing around, I think the median is the best option for a switchover point. So I went with option 3.
